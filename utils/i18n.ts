...
const resources = {
  ...
  sk: {
    translation: {
      ...
      fx_com: 'Fx - com',
      fx_com_desc:
        'Notion stránka vytvorená niekoľkými študentmi na pomoc ostatným. Môžete si tu prečítať a stiahnuť materiály k rôznym predmetom',

      mladost: 'Sprievodca Mladosťou',
      mladost_desc:
        'Notion stránka pre študentov, ktorí sa chcú nasťahovať alebo už bývajú na internáte Mladosť, kde nájdete mnoho užitočných rád',
      ...
      reg_failed: 'Registrácia zlyhala. Skúste to znova.',
  ...
  ua: {
    translation: {
      ...
      fx_com: 'Fx - com',
      fx_com_desc:
        'Сторінка в Notion, створена студентами для допомоги іншим. Тут можна читати та завантажувати матеріали з різних предметів',

      mladost: 'Гід по Mladost',
      mladost_desc:
        'Сторінка в Notion для студентів, які хочуть поселитися або вже живуть у гуртожитку Mladost. Тут є багато корисних порад',
      ...
      reg_failed: 'Реєстрація не вдалася. Спробуйте ще раз.',
